...
La comunicazione avviene tramite la chiamata di una primitiva del ricevente da parte del mittente, alla quale viene
agganciato un \textit{payload}, che contiene sia informazioni utili sia di controllo.
\section{SystemC AMS}
\chapter{VHDL}

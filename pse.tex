...
\end{sourcecode}
\begin{tikzpicture}[remember picture]
    \draw[overlay, ->] ($(pic cs:vhdl_port)+(-7,-0.1)$) -- ($(pic 
    cs:vhdl_port)+(-3,-0.8)$) node [right]{nome della costante};
    \draw[overlay, ->] ($(pic cs:vhdl_port)+(-3,-0.1)$) -- ($(pic 
    cs:vhdl_port)+(0,-0.4)$) node [right]{tipo della costante};
    \draw[overlay, ->] ($(pic cs:vhdl_port)+(0.0,0.1)$) -- ($(pic 
    cs:vhdl_port)+(0.2,0.1)$) node [right]{valore della costante};
\end{tikzpicture}

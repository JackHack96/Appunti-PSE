...
\begin{figure}[h]
    \centering
    \begin{tikzpicture}
%        \draw (1,1) rectangle (5,2) node(rtlevel)[pos=0.5,text width=5cm,align=center] {SystemC Model\\RT Level};
        \node[ellipse](rtlevel){SystemC Model\\RT Level};
        \draw (3,3) ellipse (2 and 0.5) node(refinement)[text width=5cm,align=center] {Refinement};
        \draw (3,4.5) ellipse (2 and 0.5) node(simulation)[text width=5cm,align=center] {Simulation};
        \draw (1,5.5) rectangle (5,6.5) node(systemlevel)[pos=0.5,text width=5cm,align=center] {SystemC Model\\System Level};
        
        \draw [fill=CornflowerBlue] (6,1) rectangle (10,2) node(vhdl)[pos=0.5,text width=5cm,align=center] {FSMD Logic\\description};
        \draw [fill=CornflowerBlue] (8,3) ellipse (2 and 0.5) node(synthesis)[text width=5cm,align=center] {Synthesis};
        \draw [fill=CornflowerBlue] (6,4) rectangle (10,5) node(fsmd)[pos=0.5,text width=5cm,align=center] {VHDL/Verilog};
        
        \draw [->] (systemlevel) -- (simulation);
    \end{tikzpicture}

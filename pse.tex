...
real-time simulato, utilizzando segnali di qualsiasi tipo fornito da C++/SystemC o dall'utente.
...
\end{itemize}
In SystemC è possibile descrivere sistemi hardware e software a diversi livelli di astrazione, permettendo quindi il co-design. In particolare, si può descrivere a livello RT o TLM.
\section{SystemC RTL}
...
da delle classi C++ e si specificano con la keywork \textit{\texttt{SC\_MODULE}}.

...
Questo stile si basa su un \textit{synchronous data flow} (SDF), che descrivono un sistema a eventi discreti.
Ogni evento discreto contiene un metodo C++ che calcola una funzione matematica 

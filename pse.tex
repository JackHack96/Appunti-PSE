...
Nella sezione \textit{Generic declarations} possiamo passare valori 
all'\textit{entity} a tempo di compilazione, in modo da poterla rendere 
parametrizzabile quando viene utilizzata in più occasioni.

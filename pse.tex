...
Per identificare se un client è sottoscritto a uno o più topic nella wildcard c'è un carattere speciale che identifica, single-level con la `$+$' o multi-level con `$\#$'.

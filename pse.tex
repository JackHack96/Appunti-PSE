...
SC_MODULE(shifter) {
  ...
  sc_in<sc_bv<N>> a; ?\tikzmark{shifter_input2}?
  sc_in<bool> i0; ?\tikzmark{shifter_input3}?
  sc_out<sc_bv<N>> o;
...
\end{systemc}
%TODO: aggiungere frecce con spiegazione
\section{SystemC TLM}
...
Una \textit{piattaforma} è un'architettura hardware e software complessa generica, adattabile alle mie esigenze specifiche.
...
%TODO: platform based design flow
...
rispetto a RTL), la semplificazione del design
\section{SystemC AMS}
\chapter{VHDL}

...
\usepackage{etoolbox}           % For source code frames
...
% Automatically apply tcolorbox to minted environments\
...
Analizziamo la codifica RT tramite un esempio, nel quale implementiamo un full adder a 8 bit.
\section{SystemC TLM}
\section{SystemC AMS}
\chapter{VHDL}

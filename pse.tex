...
in grado di connettersi direttamente a internet e quindi per poterlo fare hanno bisogno di connettersi ad un \textbf{gateway o un hub}, con il quale è possibile 
arrivare alla rete esterna.

Per poter capire meglio, immaginiamo di essere in un contesto industriale.
Far comunicare tutte le macchine tra loro o comunque attraverso internet con una rete Wi-Fi diventa problematico, ecco perchè molte volte si usa la 
connesione via cavo restando in locale e successivamente con un gateway si esce verso internet.

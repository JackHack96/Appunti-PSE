...
\begin{itemize}
    \item \textbf{Entity}
    \subitem Costituisce ``l'interfaccia'' del modello
    \item \textbf{Architecture}
    \subitem Costituisce la funzione effettiva del modello
    \item \textbf{Configuration}
    \subitem Si utilizza per associare un'entità ad un'architettura specifica
    \item \textbf{Package}
    \subitem Collezione di informazioni che possono essere caricati in altri modelli, come le librerie
\end{itemize}
